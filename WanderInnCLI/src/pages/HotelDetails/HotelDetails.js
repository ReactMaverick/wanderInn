...
export default function HotelDetails({navigation, route}) {
  ...
  const bookNowClicked = () => {
    dispatch(bookHotel({hotelId: hotel._id}))
      ...
      .finally(() => {
        navigation.navigate('HomeTab', {screen: 'MyBooking'});
      });
  };
  const getHotelDetails = async () => {
    ...
    try {
      ...
      const response = await getData(API_URL + `getHotelById/${id}`, token)
        .then()
        .catch()
        .finally(() => {
          setIsLoading(false);
            ...
            <View style={styles.container}>
              ...
              <View style={styles.HotelDetailsOuterRow}>
                ...
                <View style={styles.outerBox}>
                  <View style={styles.HotelCardContentInner}>
                    <View style={styles.HotelCardTop}>
                      <Text style={styles.HotelTravelTitle}>
                        Travel Dates & Guest
                      </Text>
                  ...
                  <View style={styles.roomsDatesRow}>
                    <View style={styles.roomsDatesCol}>
                      <Image
                        style={styles.roomsDatesColIcon}
                        source={CALENDER}
                      />
                      <Text style={styles.roomsDatesColText}>
                        07 May - 08 May
                      </Text>
                    </View>
                    <View style={styles.roomsDatesCol}>
                ...
                <View style={styles.MainTitle}>
                  <Text style={[commonStyles.Title, {marginBottom: 15}]}>
                    About Us
                  </Text>
                  <Text style={commonStyles.Para}>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Nulla et quam id felis aliquam aliquam. Aenean nec velit nec
                    nunc tincidunt aliquam eget in sem. Nulla et quam id felis
                    aliquam aliquam. Aenean nec velit nec nunc tincidunt aliquam
                    eget in sem.
                  </Text>
                  {/* read more btn  */}
                  <Pressable
                  ...
                  <View style={styles.FacilityRow}>
                    <View style={styles.FacilityCol}>
                      <View style={styles.FacilityIconBox}>
                        <Image style={styles.FacilityIcon} source={BED} />
                      </View>
                      <Text style={styles.FacilityText}>Beds</Text>
                    </View>
                    <View style={styles.FacilityCol}>
                      <View style={styles.FacilityIconBox}>
                        <Image style={styles.FacilityIcon} source={BATH} />
                      </View>
                      <Text style={styles.FacilityText}>1 Tub</Text>
                    </View>
                    <View style={styles.FacilityCol}>
                      <View style={styles.FacilityIconBox}>
                        <Image style={styles.FacilityIcon} source={AC} />
                      </View>
                      <Text style={styles.FacilityText}>AC</Text>
                    </View>
                    <View style={styles.FacilityCol}>
                      <View style={styles.FacilityIconBox}>
                        <Image style={styles.FacilityIcon} source={WIFI} />
                      </View>
                      <Text style={styles.FacilityText}>WIFI</Text>
                    </View>
                    <View style={styles.FacilityCol}>
                      <View style={styles.FacilityIconBox}>
                        <Image style={styles.FacilityIcon} source={DINNER} />
                      </View>
