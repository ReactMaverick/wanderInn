          ...
          <View style={styles.ProfileBoxOuter}>
            <View style={styles.ProfileBoxTop}>
              <View style={styles.ProfileBoxTopLeft}>
                <Image
                  source={user.image ? user.image : USER}
            ...
            <View style={styles.ProfileBoxBottom}>
              <View style={styles.ProgressBarArea}>
                <View style={styles.ProgressBarAreaText}>
                  <Text
                    style={[styles.ProgressBarText, {color: colors.secondary}]}>
                    72%
                  </Text>
        ...
        <View style={styles.container}>
          <View style={styles.IconListBox}>
            <View style={styles.IconListBoxUL}>
              <Pressable onPress={() => item1(0)} style={styles.IconListItem}>
                <Image
                  source={active === 0 ? USERICON : USERICON1}
              ...
              <Pressable onPress={() => item1(1)} style={styles.IconListItem}>
                <Image
                  source={active === 1 ? TRIP : TRIP1}
                  style={styles.IconListIcon}
                />
                <Text
                  style={[
              ...
              <Pressable onPress={() => item1(2)} style={styles.IconListItem}>
                <Image
                  source={active === 2 ? COUPONS : COUPONS1}
                  style={styles.IconListIcon}
                />
                <Text
                  style={[
            ...
            <View style={styles.IconListBoxUL}>
              <Pressable onPress={() => item1(3)} style={styles.IconListItem}>
                <Image
                  source={active === 3 ? ADD_CARD : ADD_CARD1}
                  style={styles.IconListIcon}
                />
                <Text
                  style={[
              ...
              <Pressable onPress={() => item1(4)} style={styles.IconListItem}>
                <Image
                  source={active === 4 ? UPI : UPI1}
                  style={styles.IconListIcon}
                />
                <Text
                  style={[
              ...
              <Pressable onPress={() => item1(5)} style={styles.IconListItem}>
                <Image
                  source={active === 5 ? GIFT : GIFT1}
                  style={styles.IconListIcon}
                />
                <Text
                  style={[
            ...
            <View style={styles.IconListBoxULnew}>
              <Pressable onPress={() => item1(6)} style={styles.IconListItem}>
                <Image
                  source={active === 6 ? ADD_CARD : ADD_CARD1}
                  style={styles.IconListIcon}
                />
                <Text
                  style={[
              ...
              <Pressable onPress={() => item1(7)} style={styles.IconListItem}>
                <Image
                  source={active === 7 ? UPI : UPI1}
                  style={styles.IconListIcon}
                />
                <Text
                  style={[
          ...
          <View style={styles.IconListBox1}>
            ...
            <View style={styles.IconListItem1}>
          ...
          <Pressable onPress={() => item1(8)} style={styles.IconListItem}>
            <Image
              source={active === 8 ? FAQ : FAQ1}
              style={styles.IconListIcon}
            />
            <Text
              style={[
